...
const Todo = ({id, text, isChecked, priority, getTodoCheck, deleteTodo, editTodoHandler}) => {
    ...
    return (
            <div className={c.toDoItem}>
                <form className={c.toDoItem_form} action="Task 31 - Redux/todo-list/src/ui/components/ToDoList/Todo/Todo#">
                    <label className={c.toDoItem_label}>
                        ...
                        <div className={`${c.toDoItem_form_controls} ${c.controls}`}>
                            <button className={c.controls_edit} onClick={editButtonHandler} type="button"><img className={c.pencil_icon} src={pencilIcon} alt="" /></button>
