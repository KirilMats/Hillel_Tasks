import c from './HumsterSVG.module.css';

const HumsterSVG = () => {
    return (
        <svg className={c.humster} id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82.1 120.03">
            <g>
                <path className={c.cls19}
                ...
                <path className={c.cls21} d="m55.89,110.26c.09-.37.18-.74.27-1.11-.27.17-.54.33-.82.48.18.21.37.42.55.64Z"/>
                <path className={c.cls14}
            ...
            <g>
                ...
                <g>
                    ...
                    <path className={c.cls15} d="m39.25,55.1c.03,1.78.07,5.22.03,5.55l.21.03c.05-.43-.03-5.37-.03-5.58h-.21Z"/>
                    <g>
                        <path className={c.cls13}
                              d="m35.86,63.28c.74,1.2,1.8,2.12,3.44,2.23,1.61.11,2.74-.52,3.57-1.43-.9-.78-2.51-2.04-3.68-2.11-1.14-.07-2.54.75-3.33,1.3Z"/>
                        <path className={c.cls11}
                ...
                <g>
                    <path className={c.cls10}
                          d="m34.55,49.16c-.5,1.4,2.47,4.5,4.8,4.66,1.87.13,5.35-2.62,5.35-3.92,0-2.47-8.77-3.84-10.15-.74Z"/>
                    <path className={c.cls4} d="m34.55,49.16c-.56,2.54,9.94,3.07,10.15.74.22-2.45-8.77-3.84-10.15-.74Z"/>
                    <rect className={c.cls17} x="39.25" y="53.82" width=".21" height="1.29"/>
                    <path className={c.cls25}
                ...
                <path className={c.cls17} d="m22.7,45.55s.99-.24,1.98-.43l-.04-.21c-1.02.2-1.9.62-1.94.64Z"/>
                <path className={c.cls17} d="m29.35,46.84c.24.23.99.92.99.92-.02-.03-.59-.83-.84-1.08l-.15.15Z"/>
                <path className={c.cls17} d="m56.83,47.09l-.07.2c.82.28,1.84,1.19,1.84,1.19-.04-.04-.9-1.09-1.77-1.39Z"/>
                <path className={c.cls16}
                ...
                <path className={c.cls17} d="m31.63,63.46s.85,1.75,1.35,2.15l.13-.17c-.47-.38-1.47-1.97-1.48-1.98Z"/>
                <path className={c.cls17} d="m44.45,67.32l.09.19c1.01-.47,1.65-1.89,1.68-1.95,0,0-.83,1.32-1.77,1.76Z"/>
                <path className={c.cls6}
                      d="m38.35,62.65c-.23-.02-.45.28-.48.67-.04.39.12.73.35.75.23.02.45-.28.48-.67.04-.39-.12-.73-.35-.75Z"/>
                <path className={c.cls8}
            ...
            <path className={c.cls24} d="m28.38,90.02s.74,2.54,0,4.43l.2.08c.29-.73.36-1.55.35-2.28-.03-1.22-.54-2.22-.54-2.22Z"/>
            <path className={c.cls24} d="m31.34,89.22s1.01,2.93.69,5.39l.21.03c.13-.99.05-2.04-.1-2.96-.22-1.42-.8-2.46-.8-2.46Z"/>
            <g>
                <path className={c.cls3}
            ...
            <path className={c.cls24} d="m53.25,91.89c-.05.82,0,1.78.33,2.64l.2-.08c-.74-1.88,0-4.4,0-4.43,0,0-.46.82-.53,1.87Z"/>
            <path className={c.cls24}
            ...
            <g>
                ...
                <path className={c.cls1} d="m73.99,103.15v-.03s-.04,0-.06,0c.02.01.04.02.06.03Z"/>
                <path className={c.cls1}
